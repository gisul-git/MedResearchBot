<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-case-reports.aspx.cs" Inherits="Admin_view_case_reports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">View Case Reports</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="WhitePaperModalLabel">Case report Details</h5>
    ...
    <script src="assets/js/pages/view-case-reports.js"></script>
</asp:Content>
