...
$(document).ready(function () {
    ...
    $(document.body).on('click', '.btnFullDesc', function () {
        var elem = $(this);
        var name = elem.attr('data-name');
        var fullDescription = elem.attr('data-fullDesc');

        // Update modal title
        $('#viewModuleFullDesc .modal-title').html('Module Full Description - ' + name);

        // Show the full description in a paragraph
        $("#FullDesc").html("<p>" + fullDescription + "</p>");
    });


    $(document.body).on('click', '.btnTextContent', function () {
        var elem = $(this);
        var name = elem.attr('data-name');
        var textContent = elem.attr('data-textContent');

        // Update modal title
        $('#viewModuleTextContent .modal-title').html('Module Text Content - ' + name);

        // Show the text content in a paragraph
