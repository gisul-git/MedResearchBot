<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="paypal-failed.aspx.cs" Inherits="paypal_failed" %>
                    ...
                    <div class="payment-failed-container">
                        <div class="text-center">
                            ...
                            <% if (!string.IsNullOrEmpty(orderGuid)) { %>
                                <a href="pay-now.aspx?order=<%=orderGuid %>" class="btn btn-primary btn-retry">
