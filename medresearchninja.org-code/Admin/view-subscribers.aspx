<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-subscribers.aspx.cs" Inherits="Admin_view_subscribers" %>
        ...
        $(document.body).on("click", ".deleteItem", function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: "view-subscribers.aspx/Delete",
