<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="request-closed-access-article.aspx.cs" Inherits="request_closed_access_article" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <div class="sidebar_list_item">
     <a href="request-closed-access-article.aspx" class="items-center d-flex justify-content-between -is-active"><span><i class="fa-regular fa-folder-open mr10"></i>Request Closed-Access Article </span> <img src="images/upcoming/sign.png" class="" width="25"/></a>
 </div>
 <div class="sidebar_list_item">
                        ...
                        <div class="col-xl-12">
                                    ...
                                    <ul id="myDropdown" class="dropdown-content">
                                       <%-- <li>
                                        ...
                                        <li><a href="/my-payment.aspx" contenteditable="false" style="cursor: pointer;"><i class="flaticon-review-1 mr10"></i>Projects Due</a><%= strDues %></li>
                                            ...
                                            <li class="active"><a href="/request-closed-access-article.aspx" class="d-flex justify-content-between align-items-center" contenteditable="false" style="cursor: pointer;"><span><i class="fa-regular fa-folder-open mr10"></i>Request Closed Access Article </span> <img src="images/upcoming/sign.png" class="" width="25" height="25"/> </a></li>
                            ...
                            <div class="ps-widget position-relative">
                                <div class="bdrb1 pb15 mb25">
                                    <h5 class="list-title fw-bold">Request Closed Access Article </h5>
                                </div>
                                <div class="col-lg-12 ">
                                    <div class="col-lg-12">
                                        <div class="plagiarism-service mt-4">
                                            <p class="mb-4">Don't let paywalls hold back your research. With our upcoming Request an Article feature, you'll be able to:</p>

                                            <div class="features-list">
                                                <div class="feature-item mb-3">
                                                    <p><strong>● Request full-text access to subscription-only or paywalled journal papers.</strong> </p>
                                                </div>

                                                <div class="feature-item mb-3">
                                                    <p><strong>● Stay evidence-based by accessing the latest studies that matter to your work.</strong></p>
                                                </div>

                                                <div class="feature-item mb-3">
                                                    <p><strong>● Save time and effort — no more endless searching for hard-to-access  papers.</strong> </p>
                                                </div>
                                            </div>

                                            <p class="mt-4">
                                                This service will make high-quality research more accessible to our community, ensuring you always have the resources you need to push your work forward.<br />
                                                <strong>Launching soon</strong> — bridging the gap between curiosity and access.👉
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="text-start">
                                                    <asp:LinkButton ID="btnPortfolio" runat="server" CssClass="ud-btn btn-thm " OnClick="btnPortfolio_Click" Text="Add Plagirism request" ValidationGroup="Save">Add Request Closed Access Article<i class="fal fa-arrow-right-long"></i></asp:LinkButton>
