...
<head runat="server">
    ...
    <meta content="ed Research Ninja" name="author" />
    <!-- App favicon -->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="text-center mt-2">
                                                <a href="/admin" class="d-inline-block auth-logo">
                                                    <img src="assets/images/logo(1).webp" alt="" height="70" />
                                                </a>
                                            </div>
                                            <div class="text-center mt-2">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <asp:TextBox runat="server" TextMode="Password" MaxLength="100" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" ID="txtPassword" />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <asp:TextBox TextMode="Password" runat="server" class="form-control pe-5 password-input" onpaste="return false" placeholder="Confirm password" ID="txtConfirmPassword" />
                                                    ...
                                                    <asp:CompareValidator ID="comp1" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" Display="Dynamic" ForeColor="Red" SetFocusOnError="true" ValidationGroup="Reset" ErrorMessage="Password doesn't match"></asp:CompareValidator><br />
