<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="project-due-paypal-failed.aspx.cs" Inherits="project_due_paypal_failed" %>
                    ...
                    <div class="payment-failed-container">
                        <div class="text-center">
                            ...
                            <% if (!string.IsNullOrEmpty(paymentGuid))
                                { %>
                            <a href="pay-project-due.aspx?pid=<%=paymentGuid %>" class="btn btn-primary btn-retry">
