<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-other-members.aspx.cs" Inherits="Admin_view_other_members" %>
         ...
         <div class="row">
             <div class="col-12">
                 <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0">View Other Members</h4>

                     <div class="page-title-right">
                         <ol class="breadcrumb m-0">
                             <li class="breadcrumb-item"><a href="/javascript: void(0);">Dashboard</a></li>
                             <li class="breadcrumb-item"><a href="/javascript: void(0);">Other Members</a></li>
     ...
     <div class="container-fluid">
         <div class="card">
             ...
             <div class="card-header">
                 <h5 class="card-title">Manage Other Members</h5>
             </div>
             <div class="card-body">
                 <div class="row">
                     <div class="col-lg-12">
     ...
     $(document.body).on("click", ".deleteItem", function () {
         ...
         swal.fire({
             ...
             if (result.value) {
                 $.ajax({
                     type: 'POST',
                     url: "view-other-members.aspx/Delete",
