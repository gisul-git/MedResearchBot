...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection conMN)
    {
    ...
    public static int InsertUserRoles(SqlConnection conMN, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection conMN, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection conMN, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection conMN, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection conMN, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection conMN, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection conMN, UserRolesAccess cat)
    {
        int result = 0;
